<?php 
 ...
 if(isset($_FILES['pic']['name']) && isset($_POST['tags'])&& isset($_POST['name'])){
 
 //uploading file and storing it to database as well 
 try{
 move_uploaded_file($_FILES['pic']['tmp_name'], UPLOAD_PATH . $_FILES['pic']['name']);
 $stmt = $conn->prepare("INSERT INTO bus_detail (bus_image, tags, name) VALUES (?,?,?)");
 $stmt->bind_param("sss", $_FILES['pic']['name'],$_POST['tags'],$_POST['name']);
 if($stmt->execute()){
